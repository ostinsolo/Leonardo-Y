    ...
    def get_memory_stats(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            try:
                ...
                # For now, return basic stats from the service directly
                return {
                    "backend_type": self.fastmcp_service.backend_type,
                    "enhanced_available": getattr(self.fastmcp_service, 'enhanced_memory', None) is not None,
                    "user_id": user_id,
                    "fastmcp_server_available": self.fastmcp_service.get_mcp_server() is not None,
                    "timestamp": datetime.now().isoformat()
                }
        except Exception as e:
